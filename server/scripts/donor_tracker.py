...
def store_to_db(list_of_dicts):
    myclient = pymongo.MongoClient(f'mongodb://{os.environ.get("DB_USER")}:{os.environ.get("DB_PASSWORD")}@{os.environ.get("DB_HOST")}/?authSource=admin')
